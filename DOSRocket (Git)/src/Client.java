...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(68, 68, 68)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(fdev, javax.swing.GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
                            .addComponent(fname)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(floc, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jButton1.setText("Load/Refresh List");
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Action buttons", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 11))); // NOI18N
    ...
    private void SaveConfigButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveConfigButtonActionPerformed
      ...
      Thread SaveConfigThread=new Thread(new Runnable()
      {
        ...
        if(k){
            System.out.println("Successfully connected to MySQL Server\nSearching for Database...\n");
                ...
                if(ras.first()){
                    ...
                    st.executeUpdate("create table dosrocket(name varchar(50) PRIMARY KEY,developer varchar(50), filepath varchar(5000),filename varchar(256),albumpath varchar(5000))");
                }
        ...
        String albumpat=albumpath.getText();
        con.createStatement();
        String query="insert into dosrocket values('"+filename+"','"+filedev+"','"+filelocn+"','"+filenam+"','"+albumpat+"')";
    ...
    private void browsebutton1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_browsebutton1MouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_browsebutton1MouseEntered

    private void browsebutton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_browsebutton1ActionPerformed
        // TODO add your handling code here:
         JFileChooser imgbrowze = new JFileChooser();
        int returnval=imgbrowze.showOpenDialog(this);
        if(returnval==JFileChooser.APPROVE_OPTION)
        {
        File target=imgbrowze.getSelectedFile();
            String imfile=target.getPath();
            String yo=imfile.replace("\\","\\\\\\");
             albumpath.setForeground(Color.BLACK);
             albumpath.setFont(isFocused);
             albumpath.setText(yo);
    ...
    private javax.swing.JTextField albumpath;
